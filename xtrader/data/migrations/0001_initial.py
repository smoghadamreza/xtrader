    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cash",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="وجه نقد"
                    ),
                ),
                (
                    "net_receivables",
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        null=True,
                        verbose_name="سرمایه های کوتاه مدت",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        null=True,
                        verbose_name="سرمایه گذاری بلند مدت",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        null=True,
                        verbose_name="دارایی های نامشهود",
                    ),
                ),
                (
                    "total_assets",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="دارایی "
                    ),
                ),
                (
                    "accounts_payable",
                ...
                (
                    "total_liabilities",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="بدهی"
                    ),
                ),
                (
                    "capital",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="سرمایه"
                    ),
                ),
                (
                    "retained_earnings",
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        null=True,
                        verbose_name="حقوق صاحبان سرمایه",
                    ),
                ),
                (
                    "prepayment",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "total_income",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="فروش"
                    ),
                ),
                (
                    "gross_profit",
                ...
                (
                    "net_income",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="سود خالص"
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        null=True,
                        verbose_name="دوره گردش دریافتنی (روز)",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ReferencePriceVariation",
                    models.DecimalField(decimal_places=1, max_digits=7),
                ),
                (
                    "ReferencePriceVariationPercent",
                    models.DecimalField(decimal_places=2, max_digits=4),
                ),
                (
                    "YearHighestTradePrice",
                    models.DecimalField(decimal_places=1, max_digits=7),
                ),
                (
                    "YearLowestTradePrice",
                    models.DecimalField(decimal_places=1, max_digits=7),
                ),
