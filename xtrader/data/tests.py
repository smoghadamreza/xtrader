...
def sendemail(
    firstname="hossein", lastname="yazdi", email="iran581@gmail.com"
):
    subject, from_email = "hello", "info.xtrader@gmail.com"
    text_content = "This is an important message."
    html_content = render_to_string(
        "invetemail.html", {"firstname": firstname, "lastname": lastname}
    )
...
i = 1
while sheet.cell(row=i, column=12).value is not None:
    ...
    if sheet.cell(row=i, column=14).value is not None:
